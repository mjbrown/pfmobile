...
public class FilterSelect {
	...
	List<Map<String, String>> selectionNames = new ArrayList<Map<String, String>>();
	List<List<Map<String, String>>> selectionDesc = new ArrayList<List<Map<String, String>>>();
	List<List<Map<String, String>>> selectionPrereqs = new ArrayList<List<Map<String, String>>>();
